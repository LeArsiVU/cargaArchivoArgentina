...
use coppel_ar; -- Para ingredar a la  base de datos creada

-- Se crea la tabla donde se va a cargar el archivo
-- Vuelvan a checar los nombres que deben tener los campos,
-- diganle a Ramón Romero que les pase el archivo drive sobre el estándar de DOMO, ahí viene lo de los nombres.
...
-- Se carga el archivo a la tabla creada anteriormente
